// newsData.js
import a from "../components/img/generations/eme.png";
import a2 from "../components/img/generations/2.png";
import a3 from "../components/img/generations/3.png";
import a4 from "../components/img/generations/4.png";
import a5 from "../components/img/generations/5.png";
import a6 from "../components/img/generations/6.png";
import a7 from "../components/img/generations/7.png";
import a8 from "../components/img/generations/8.png";
import a9 from "../components/img/generations/9.png";
import a10 from "../components/img/generations/10.png";
import a11 from "../components/img/generations/11.png";
import a12 from "../components/img/generations/12.png";
import a13 from "../components/img/generations/13.png";
import a14 from "../components/img/generations/14.png";
import a15 from "../components/img/generations/16.png";

const ageCategories = [
  {
    id: 1,
    title: "0-1",
    firstP: "Нярай үе: 0-28 хоног",
    developText:
      "Энэ үед хүүхэд шинэ орчинд дасан зохицож буй учир түүний бие махбодын үйл ажиллагаанд эрчимтэй өөрчлөлт гарна. ## •	Төрөхийн өмнөх хөгжлийн үед ургийн зүрх, бөөр, дотоод шүүрлийн булчирхай, цус бүтээх, төлжүүлэх үйл ажиллагаа зэрэг эрхтэн систем идэвхтэй ажилладаг бол төрсний дараа амьсгал, хоол боловсруулах эрхтнүүд болон цусны бага эргэлт ажиллагаанд ордог. ## •	Хүүхэд төрж, хүй таслахад 2 артери, 1 венийн судас таслагддаг бөгөөд хүйгээр халдвар авах магадлалтай тул арчилгаа сувилгаа чухал. ## •	Шинээр төрсөн хүүхдийн биеийн жин 2800-3500гр, урт 48-52 см, толгойн тойрог  34-36 см, цээжний тойрог 34-35 см байдаг. Физиологийн үзүүлэлтийн хувьд цусны даралт -40 мм мөнгөн усны багана, ходоодны эзлэхүүн 35 мл, тархи нь тархи нь 350-390 гр жинтэй, амьсгал 1 минутад 40-60 удаа жигд бус өнгөц амьсгалж, зүрх 120-140 удаа цохилдог. ## •	Хүүхэд төрөхдөө удамшлаар тогтсон зарим бэлэн рефлексийн тусламжтайгаар орчны шинэ нөхцөлд зохицон амьдарна. Үүнд: залгих, хөхөх, үмхэх, хамгаалах (хурц гэрэл гэх мэтээс), амтлах, хүрэлцэх, мэдрэх рефлексүүдтэй байна.",
